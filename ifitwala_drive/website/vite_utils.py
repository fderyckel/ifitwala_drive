...
def get_vite_assets(
	...
	"""Return the Vite entry asset, CSS assets, and imported JS chunks."""
	manifest = {}
	...
	candidates = entry_keys or ["index.html", "src/apps/workspace/main.ts", "src/apps/workspace/main.js"]
	entry = None
